...
The SELECT acknowledgment decision is superseded by [SELECT readiness without acknowledgment](0021-select-readiness-without-acknowledgment.md). Mutation readiness remains unchanged.
